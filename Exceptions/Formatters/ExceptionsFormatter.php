...
namespace Bertshang\Porto\Exceptions\Formatters;

use Exception;
use Illuminate\Http\JsonResponse;
use Bertshang\Api\Formatters\BaseFormatter as BertshangBaseFormatter;
 ...
 */
abstract class ExceptionsFormatter extends BertshangBaseFormatter
{
