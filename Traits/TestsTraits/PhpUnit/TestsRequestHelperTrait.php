...
namespace Bertshang\Porto\Traits\TestsTraits\PhpUnit;
...
trait TestsRequestHelperTrait
{
    ...
    private function buildUrlForUri($uri)
    {
        ...
        return Config::get('porto.api.url') . $uri;
    }
    ...
    {
        return (Config::get('porto.hash-id') && !$skipEncoding) ? Hashids::encode($id) : $id;
    }
