...
class ContainerApiGenerator extends GeneratorCommand implements ComponentsGenerator
{
     ...
     * @var string
     */
    protected $name = 'porto:generate:container:api';
     ...
     * @var string
     */
    protected $description = 'Create a Container for porto from scratch (API Part)';
    ...
    public function getUserInputs()
    {
        ...
        $this->call('porto:generate:readme', [
        ...
        $this->call('porto:generate:configuration', [
            '--container'   => $containerName,
            '--file'        => $_containerName,
        ]);
        ...
        $this->call('porto:generate:serviceprovider', [
            '--container'   => $containerName,
        ...
        $this->call('porto:generate:model', [
            '--container'   => $containerName,
            '--file'        => $model,
            '--repository'  => true,
        ]);
        ...
        $this->call('porto:generate:migration', [
            '--container'   => $containerName,
        ...
        $this->call('porto:generate:transformer', [
            '--container'   => $containerName,
        ...
        {
            $this->call('porto:generate:route', [
                '--container' => $containerName,
                '--file' => $route['name'],
                '--ui' => $ui,
            ...
            $this->call('porto:generate:request', [
                '--container' => $containerName,
                '--file' => $route['request'],
                '--ui' => $ui,
            ...
            $this->call('porto:generate:action', [
                '--container' => $containerName,
                '--file' => $route['action'],
                '--model' => $model,
                '--stub' => $route['stub'],
        ...
        $this->call('porto:generate:controller', [
            '--container'   => $containerName,
            '--file'        => 'Controller',
            '--ui'          => $ui,
            '--stub'        => 'crud.' . $ui,
