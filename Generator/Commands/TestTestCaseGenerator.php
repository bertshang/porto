...
class TestTestCaseGenerator extends GeneratorCommand implements ComponentsGenerator
{
     ...
     * @var string
     */
    protected $name = 'porto:generate:test:testcase';
    ...
    {
        // we manually set the filename to TestCase as this is the preferred name within porto
        ...
        if ($ui != 'generic') {
            $this->call('porto:generate:test:testcase', [
