...
class ContainerGenerator extends GeneratorCommand implements ComponentsGenerator
{
     ...
     * @var string
     */
    protected $name = 'porto:generate:container';
     ...
     * @var string
     */
    protected $description = 'Create a Container for porto from scratch';
    ...
    public function getUserInputs()
    {
        ...
        if ($ui == 'api' || $ui == 'both') {
            $this->call('porto:generate:container:api', [
        ...
        if ($ui == 'web' || $ui == 'both') {
            $this->call('porto:generate:container:web', [
                '--container'    => $containerName,
                '--file'         => 'composer',
                '--transporters' => $useTransporters,
            ]);
