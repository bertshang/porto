...
namespace Bertshang\Porto\Providers;

use Bertshang\Porto\Abstracts\Events\Providers\EventServiceProvider;
use Bertshang\Porto\Abstracts\Providers\MainProvider as AbstractMainProvider;
use Bertshang\Porto\Foundation\Apiato;
use Bertshang\Porto\Generator\GeneratorsServiceProvider;
use Bertshang\Porto\Loaders\AutoLoaderTrait;
use Bertshang\Porto\Loaders\FactoriesLoaderTrait;
use Bertshang\Porto\Traits\ValidationTrait;
...
use Bertshang\Api\Provider\LaravelServiceProvider as BertshangExceptionsServiceProvider;
...
class ApiatoProvider extends AbstractMainProvider
{
    ...
    public $serviceProviders = [
        ...
        BertshangExceptionsServiceProvider::class,
    ...
    {
        App::register(EventServiceProvider::class); //The custom porto eventserviceprovider
    }
