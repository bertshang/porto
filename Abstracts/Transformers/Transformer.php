...
namespace Bertshang\Porto\Abstracts\Transformers;

use Bertshang\Porto\Exceptions\CoreInternalErrorException;
use Bertshang\Porto\Exceptions\UnsupportedFractalIncludeException;
...
abstract class Transformer extends FractalTransformer
{
    ...
    protected function callIncludeMethod(Scope $scope, $includeName, $data)
    {
        try {
            ...
            if (Config::get('porto.requests.force-valid-includes', true)) {
