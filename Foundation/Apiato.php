...
namespace Bertshang\Porto\Foundation;

use Bertshang\Porto\Exceptions\ClassDoesNotExistException;
use Bertshang\Porto\Exceptions\MissingContainerException;
use Bertshang\Porto\Exceptions\WrongConfigurationsException;
use Bertshang\Porto\Traits\CallableTrait;
...
class Apiato
{
    ...
    {
        $loginPage = Config::get('porto.containers.login-page-url');
